...
#if !defined(WIN32_UWSAPI_STATIC)
#if defined(WIN32_UWSAPI)
#define WIN32_UWSAPI __declspec(dllexport)
#else
#define WIN32_UWSAPI __declspec(dllimport)
#endif
#else
#define WIN32_UWSAPI
#endif
...
public:
    friend Context WIN32_UWSAPI createContext(std::string certChainFileName, std::string keyFileName, std::string keyFilePassword);
...
Context WIN32_UWSAPI createContext(std::string certChainFileName, std::string keyFileName, std::string keyFilePassword = std::string());
